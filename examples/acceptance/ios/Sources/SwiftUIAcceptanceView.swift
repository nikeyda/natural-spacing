...
@MainActor
struct SwiftUIAcceptanceView: View {
        ...
        NavigationView {
            ScrollView {
                VStack(alignment: .leading, spacing: 12) {
                    Text("Use synthetic text only. Compare binding publication, composition, selection, paste, undo, dictation, hardware keyboards, focus, lifecycle, and VoiceOver with the UIKit tab.")
                        .font(.footnote)
            ...
            .navigationBarTitle("SwiftUI acceptance", displayMode: .inline)
        }
    }
